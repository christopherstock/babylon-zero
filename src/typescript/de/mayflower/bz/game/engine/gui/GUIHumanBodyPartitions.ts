...
/*
            ...
            for (let i:number = 0; i < GUIHumanBodyPartitions.VISOR_COLORS.length; ++i )
            {
                const visorColor :BABYLON.Color3 = GUIHumanBodyPartitions.VISOR_COLORS[ i ];
                ...
                (
                    GUIHumanBodyPartitions.VISOR_COLOR_NAMES[ i ],
                    bz.SettingGUI.GUI_FONT_SIZE_DEFAULT,
                    colorCss,
                    GUIHumanBodyPartitions.VISOR_COLOR_SHADOWS[ i ],
                    80,
                    203 + ( i * 30 ),
                    300,
                    20,
            ...
            for (let i:number = 0; i < GUIHumanBodyPartitions.HELMET_COLORS.length; ++i )
            {
                const helmetColor :BABYLON.Color3 = GUIHumanBodyPartitions.HELMET_COLORS[ i ];
                const colorCss   :string         = (
                    'rgb( '
                    + ( helmetColor.r * 255 )
                    + ', '
                ...
                const colorCaption:BABYLON_GUI.TextBlock = bz.GUIFactory.createTextBlock
                (
                    GUIHumanBodyPartitions.HELMET_COLOR_NAMES[ i ],
                    bz.SettingGUI.GUI_FONT_SIZE_DEFAULT,
                    colorCss,
                    GUIHumanBodyPartitions.HELMET_COLOR_SHADOWS[ i ],
                    80,
                    373 + ( i * 30 ),
                    300,
                    20,
