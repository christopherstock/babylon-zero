...
export class ModelSystem
{
    ...
    *******************************************************************************************************************/
    public async load( scene:BABYLON.Scene ) : Promise<void>
    {
        ...
        for ( const fileName of this.fileNames )
        {
            ...
            this.models[ fileName ] = await ModelSystem.loadModel( scene, fileName );
        }
    ...
    public static async loadModel( scene:BABYLON.Scene, fileName:string ) : Promise<bz.Model|void>
    {
