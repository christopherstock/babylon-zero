...
export class DoorData
{
    ...
    public width            :number           = bz.SettingAEC.DOOR_WIDTH;
    public noDoorFrame      :boolean          = false;
    ...
    *******************************************************************************************************************/
    public constructor(
        ...
        width           :number           = bz.SettingAEC.DOOR_WIDTH,
        noDoorFrame     :boolean          = false
    )
    {
