    ...
    *******************************************************************************************************************/
    protected createStageContents( meshFactory:bz.MeshFactory ) : void
    {
        ...
        bz.StageFactory.addRoomWalls(
            ...
            0.0,
            bz.TextureFile.WALL_WOOD_VERT_1, [ new bz.DoorData( 1.0, eventsDoorLocked, bz.DoorAnimation.SWING_DEFAULT ) ], [ 7.0 ], 2.0,
            bz.TextureFile.WALL_WOOD_PLANKS, [ new bz.DoorData( 1.0, eventsDoorLocked, bz.DoorAnimation.SWING_DEFAULT ) ], [ 7.0 ], 3.0,
            bz.TextureFile.WALL_WOOD_GRAIN,  [ new bz.DoorData( 1.0, eventsDoorLocked, bz.DoorAnimation.SWING_DEFAULT ) ], [ 7.0 ], 4.0,
            bz.TextureFile.WALL_WOOD_OLIVE,  [ new bz.DoorData( 1.0, eventsDoorLocked, bz.DoorAnimation.SWING_DEFAULT ) ], [ 7.0 ], 5.0,
