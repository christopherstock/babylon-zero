...
export class TextureFile
{
    ...
    public static readonly WALL_ASPHALT_CRACKED         :TextureFile            = new TextureFile( 'wall/asphaltCracked.jpg',       bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_CONCRETE, bz.TextureType.WALL );
    public static readonly WALL_BRICKS_ORANGE           :TextureFile            = new TextureFile( 'wall/bricksOrange.jpg',         bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_CONCRETE, bz.TextureType.WALL );
    public static readonly WALL_BRICKS_MOSSY_STONES     :TextureFile            = new TextureFile( 'wall/bricksMossyStones.jpg',    bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_CONCRETE, bz.TextureType.WALL );
    public static readonly WALL_BRICKS_DARK_RED         :TextureFile            = new TextureFile( 'wall/bricksDarkRed.jpg',        bz.TextureHasAlpha.NO,  bz.TextureUV.Y_ONE_XZ_TILED,     TextureFile.BULLET_HOLE_CONCRETE, bz.TextureType.WALL );
    ...
    public static readonly WALL_CONCRETE_DARK           :TextureFile            = new TextureFile( 'wall/concreteDark.jpg',         bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    public static readonly WALL_CONCRETE_NEW            :TextureFile            = new TextureFile( 'wall/concreteNew.jpg',          bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    ...
    public static readonly WALL_DOOR_INDUSTRIAL         :TextureFile            = new TextureFile( 'wall/doorIndustrial.jpg',       bz.TextureHasAlpha.NO,  bz.TextureUV.ALL_TO_ONE,         TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    ...
    public static readonly WALL_PAVEMENT_GRANITE        :TextureFile            = new TextureFile( 'wall/pavementGranite.jpg',      bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE_HALF, TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    ...
    public static readonly WALL_STONES_DARK_GRANITE     :TextureFile            = new TextureFile( 'wall/stonesDarkGranite.jpg',    bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    public static readonly WALL_STONES_PAVEMENT         :TextureFile            = new TextureFile( 'wall/stonesPavement.jpg',       bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    public static readonly WALL_STONES_WHITE_PEBBLES    :TextureFile            = new TextureFile( 'wall/stonesWhitePebbles.jpg',   bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE_HALF, TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    public static readonly WALL_STONES_YELLOW_TILES     :TextureFile            = new TextureFile( 'wall/stonesYellowTiles.jpg',    bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    ...
    public static readonly WALL_TILES_PAINTED_ORNAMENTS :TextureFile            = new TextureFile( 'wall/tilesPaintedOrnament.jpg', bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_CONCRETE, bz.TextureType.WALL );
    ...
    public static readonly WALL_WOOD_GRAIN              :TextureFile            = new TextureFile( 'wall/woodGrain.jpg',            bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE,      TextureFile.BULLET_HOLE_WOOD,     bz.TextureType.WALL );
