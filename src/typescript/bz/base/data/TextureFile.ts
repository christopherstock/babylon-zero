...
export class TextureFile
{
    ...
    public static readonly WALL_COBBLES_6               :TextureFile            = new TextureFile( 'wall/cobbles6.jpg',         bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE, TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    ...
    public static readonly WALL_MARBLE_2                :TextureFile            = new TextureFile( 'wall/marble2.jpg',          bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE, TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    ...
    public static readonly WALL_STONES_4                :TextureFile            = new TextureFile( 'wall/stones4.jpg',          bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE, TextureFile.BULLET_HOLE_METAL,    bz.TextureType.WALL );
    ...
    public static readonly WALL_WOOD_1                  :TextureFile            = new TextureFile( 'wall/wood1.jpg',            bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE, TextureFile.BULLET_HOLE_WOOD,     bz.TextureType.WALL );
    public static readonly WALL_WOOD_2                  :TextureFile            = new TextureFile( 'wall/wood2.jpg',            bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE, TextureFile.BULLET_HOLE_WOOD,     bz.TextureType.WALL );
    public static readonly WALL_WOOD_3                  :TextureFile            = new TextureFile( 'wall/wood3.jpg',            bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE, TextureFile.BULLET_HOLE_WOOD,     bz.TextureType.WALL );
    public static readonly WALL_WOOD_4                  :TextureFile            = new TextureFile( 'wall/wood4.jpg',            bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE, TextureFile.BULLET_HOLE_WOOD,     bz.TextureType.WALL );
    public static readonly WALL_WOOD_5                  :TextureFile            = new TextureFile( 'wall/wood5.jpg',            bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_BY_SIZE, TextureFile.BULLET_HOLE_WOOD,     bz.TextureType.WALL );
