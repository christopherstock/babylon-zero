...
export class TextureFile
{
    ...
    public static readonly WALL_TEST                    :TextureFile            = new TextureFile( 'wall/test.jpg',                 bz.TextureHasAlpha.NO,  bz.TextureUV.TILED_DOUBLE, TextureFile.BULLET_HOLE_CONCRETE, bz.TextureType.WALL );
