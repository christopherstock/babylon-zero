    ...
    export class MfgMaterial
    {
        ...
        *****************************************************************************/
        public static initMaterials( scene:BABYLON.Scene )
        {
            ...
            MfgMaterial.materialTest1.diffuseTexture = new BABYLON.Texture( bz.MfgSettings.PATH_IMAGE_TEXTURE + "test1.jpg", scene );
            ...
            MfgMaterial.materialMFLogo.diffuseTexture = new BABYLON.Texture( bz.MfgSettings.PATH_IMAGE_TEXTURE + "mfLogo.jpg", scene );
            ...
            MfgMaterial.materialAmiga.diffuseTexture = new BABYLON.Texture( bz.MfgSettings.PATH_IMAGE_TEXTURE + "mosaic.jpg", scene );
            ...
            MfgMaterial.materialWood.diffuseTexture = new BABYLON.Texture( bz.MfgSettings.PATH_IMAGE_TEXTURE + "wood.jpg", scene );
            ...
            MfgMaterial.materialGrass.diffuseTexture = new BABYLON.Texture( bz.MfgSettings.PATH_IMAGE_TEXTURE + "grass.jpg", scene );
            ...
            MfgMaterial.materialGlass.diffuseTexture = new BABYLON.Texture( bz.MfgSettings.PATH_IMAGE_TEXTURE + "glass.jpg", scene );
